...
export const addMyCampsite = async (campsiteFormData: any) => {
  try {
...
export const searchCampsites = async (searchParams: { destination: any; checkIn: any; checkOut: any; adultCount: any; childCount: any; page: any; }) => {
